...
function generatePassword() {
  ...
  //Verify that the user input is a number and length is between 8 and 100 characters.
  ...
  //Confirms if user wants uppercase letters in the password and adds them to usesdChars if true.
  ...
  //Confirms if user wants lowercase letters in the password and adds them to usesdChars if true.
  ...
  //Confirms if user wants numbers in the password and adds them to usesdChars if true.
  var useNumbers = window.confirm("Will your password use numbers?")
  if (useNumbers === true) { usedChars = usedChars + numbers};

  //Confirms if user wants special characters in the password and adds them to usesdChars if true.
